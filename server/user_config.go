...
type UserConfig struct {
	...
	// SilenceVCSStatusPreWorkflowHook is whether to skip VCS commit status updates for pre workflow hooks.
	SilenceVCSStatusPreWorkflowHook bool            `mapstructure:"silence-vcs-status-pre-workflow-hook"`
