...
type UserConfig struct {
	...
	VCSPullReqStatusFetcherBackoff    int64           `mapstructure:"vcs-pull-req-status-fetcher-backoff"`
	VCSPullReqStatusFetcherRetryTimes int             `mapstructure:"vcs-pull-req-status-fetcher-retry-times"`
