...
//
//	mockgen -package mocks -destination server/controllers/web_templates/mocks/mock_template_writer.go github.com/runatlantis/atlantis/server/controllers/web_templates TemplateWriter
//
