...
//go:generate pegomock generate github.com/runatlantis/atlantis/server/controllers/events --package mocks -o mocks/mock_azuredevops_request_validator.go AzureDevopsRequestValidator
