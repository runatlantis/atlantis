...
//go:generate pegomock generate github.com/runatlantis/atlantis/server/controllers/events --package mocks -o mocks/mock_gitlab_request_parser_validator.go GitlabRequestParserValidator
