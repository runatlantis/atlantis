...
func (mock *MockProjectCommandOutputHandler) Send(ctx *models.ProjectCommandContext, msg string, operationComplete bool) {
	if mock == nil {
...
func (verifier *VerifierMockProjectCommandOutputHandler) Send(ctx *models.ProjectCommandContext, msg string, operationComplete bool) *MockProjectCommandOutputHandler_Send_OngoingVerification {
	params := []pegomock.Param{ctx, msg, operationComplete}
