...
func TestRun(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expectedResult := `[{"PolicySetName":"policy1","ConftestOutput":"Success","PolicyHash":"505a83f220c02df2f85c3810cd9ceb38","Passed":true,"ReqApprovals":0,"CurApprovals":0},{"PolicySetName":"policy2","ConftestOutput":"Success","PolicyHash":"505a83f220c02df2f85c3810cd9ceb38","Passed":true,"ReqApprovals":0,"CurApprovals":0}]`
	...
	t.Run("success extra args", func(t *testing.T) {
		...
		expectedOutput := "Success"
		expectedResult := `[{"PolicySetName":"policy1","ConftestOutput":"","PolicyHash":"d41d8cd98f00b204e9800998ecf8427e","Passed":true,"ReqApprovals":0,"CurApprovals":0},{"PolicySetName":"policy2","ConftestOutput":"","PolicyHash":"d41d8cd98f00b204e9800998ecf8427e","Passed":true,"ReqApprovals":0,"CurApprovals":0}]`
	...
	t.Run("error resolving one policy source", func(t *testing.T) {
		...
		expectedOutput := "Success"
		expectedResult := `[{"PolicySetName":"policy1","ConftestOutput":"Success","PolicyHash":"505a83f220c02df2f85c3810cd9ceb38","Passed":true,"ReqApprovals":0,"CurApprovals":0}]`
	...
	t.Run("error running one cmd", func(t *testing.T) {
		...
		expectedResult := `[{"PolicySetName":"policy1","ConftestOutput":"FAIL - \u003credacted plan file\u003e - failure\n1 tests, 0 passed, 0 warnings, 1 failure, 0 exceptions","PolicyHash":"f1785adcc8f7ef0be131bcb88073db82","Passed":false,"ReqApprovals":0,"CurApprovals":0},{"PolicySetName":"policy2","ConftestOutput":"Success","PolicyHash":"505a83f220c02df2f85c3810cd9ceb38","Passed":true,"ReqApprovals":0,"CurApprovals":0}]`
	...
	t.Run("error running both cmds", func(t *testing.T) {
		...
		expectedResult := `[{"PolicySetName":"policy1","ConftestOutput":"FAIL - \u003credacted plan file\u003e - failure\n1 tests, 0 passed, 0 warnings, 1 failure, 0 exceptions","PolicyHash":"f1785adcc8f7ef0be131bcb88073db82","Passed":false,"ReqApprovals":0,"CurApprovals":0},{"PolicySetName":"policy2","ConftestOutput":"FAIL - \u003credacted plan file\u003e - failure\n1 tests, 0 passed, 0 warnings, 1 failure, 0 exceptions","PolicyHash":"f1785adcc8f7ef0be131bcb88073db82","Passed":false,"ReqApprovals":0,"CurApprovals":0}]`
