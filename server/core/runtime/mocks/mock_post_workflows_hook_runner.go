...
func (mock *MockPostWorkflowHookRunner) Run(ctx models.WorkflowHookCommandContext, command string, hookId string, path string, outputHandler jobs.ProjectCommandOutputHandler) (string, string, error) {
	if mock == nil {
...
func (verifier *VerifierMockPostWorkflowHookRunner) Run(ctx models.WorkflowHookCommandContext, command string, hookId string, path string, outputHandler jobs.ProjectCommandOutputHandler) *MockPostWorkflowHookRunner_Run_OngoingVerification {
	params := []pegomock.Param{ctx, command, hookId, path, outputHandler}
...
func (c *MockPostWorkflowHookRunner_Run_OngoingVerification) GetCapturedArguments() (models.WorkflowHookCommandContext, string, string, string, jobs.ProjectCommandOutputHandler) {
...
func (c *MockPostWorkflowHookRunner_Run_OngoingVerification) GetAllCapturedArguments() (_param0 []models.WorkflowHookCommandContext, _param1 []string, _param2 []string, _param3 []string, _param4 []jobs.ProjectCommandOutputHandler) {
