...
//go:generate mockgen -destination=mocks/mock_version_path.go -package=mocks . ExecutionVersionCache
//go:generate mockgen -destination=mocks/mock_key_serializer.go -package=mocks . KeySerializer
