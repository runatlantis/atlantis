...
// Source: github.com/runatlantis/atlantis/server/core/coordination (interfaces: ApplyLockChecker)
//
...
func (m *MockApplyLockChecker) CheckApplyLock() (coordination.ApplyCommandLock, error) {
	m.ctrl.T.Helper()
