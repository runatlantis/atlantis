...
// Source: github.com/runatlantis/atlantis/server/core/coordination (interfaces: Locker)
//
...
func (m *MockLocker) TryLock(p models.Project, workspace string, pull models.PullRequest, user models.User) (coordination.TryLockResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TryLock", p, workspace, pull, user)
	ret0, _ := ret[0].(coordination.TryLockResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
