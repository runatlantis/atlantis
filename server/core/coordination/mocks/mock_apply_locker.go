...
// Source: github.com/runatlantis/atlantis/server/core/coordination (interfaces: ApplyLocker)
//
...
import (
	...
	coordination "github.com/runatlantis/atlantis/server/core/coordination"
...
func (m *MockApplyLocker) CheckApplyLock() (coordination.ApplyCommandLock, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckApplyLock")
	ret0, _ := ret[0].(coordination.ApplyCommandLock)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplyLocker) LockApply() (coordination.ApplyCommandLock, error) {
	m.ctrl.T.Helper()
