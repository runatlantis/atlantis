...
//go:generate mockgen -destination=mocks/mock_apply_lock_checker.go -package=mocks . ApplyLockChecker
...
//go:generate mockgen -destination=mocks/mock_apply_locker.go -package=mocks . ApplyLocker
