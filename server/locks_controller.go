...
func (l *LocksController) DeleteLock(w http.ResponseWriter, r *http.Request) {
	...
	deleteLockResult, lock, err := l.DeleteLockCommand.DeleteLock(idUnencoded)

	switch deleteLockResult {
	case models.DeleteLockSuccess:
