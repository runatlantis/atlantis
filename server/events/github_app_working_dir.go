...
func (g *GithubAppWorkingDir) Clone(log logging.SimpleLogging, headRepo models.Repo, p models.PullRequest) (string, bool, error) {
	...
	return g.WorkingDir.Clone(log, headRepo, p)
}
