...
func TestExecuteCommand_LogPanics(t *testing.T) {
	...
	When(ghStatus.Update(fixtures.Repo, fixtures.Pull, vcs.Pending, nil, models.Github)).ThenPanic("panic")
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, 1, nil, models.Github)
...
func TestExecuteCommand_NoGitlabMergeGetter(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, 1, nil, models.Gitlab)
...
func TestExecuteCommand_GithubPullErr(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, fixtures.Pull.Num, nil, models.Github)
...
func TestExecuteCommand_GitlabMergeRequestErr(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, fixtures.Pull.Num, nil, models.Gitlab)
...
func TestExecuteCommand_ForkPRDisabled(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, models.Repo{} /* this isn't used */, fixtures.User, fixtures.Pull.Num, nil, models.Github)
	vcsClient.VerifyWasCalledOnce().CreateComment(fixtures.Repo, modelPull.Num, "Atlantis commands can't be run on fork pull requests. To enable, set --"+ch.AllowForkPRsFlag, models.Github)
}
...
func TestExecuteCommand_ClosedPull(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, fixtures.Pull.Num, nil, models.Github)
	vcsClient.VerifyWasCalledOnce().CreateComment(fixtures.Repo, modelPull.Num, "Atlantis commands can't be run on closed pull requests", models.Github)
}
...
func TestExecuteCommand_WorkspaceLocked(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, fixtures.Repo, fixtures.User, fixtures.Pull.Num, &cmd, models.Github)

	msg := "The workspace workspace is currently locked by another" +
		" command that is running for this pull request." +
		" Wait until the previous command is complete and try again."
	ghStatus.VerifyWasCalledOnce().Update(fixtures.Repo, fixtures.Pull, vcs.Pending, &cmd, models.Github)
...
func TestExecuteCommand_ForkPREnabled(t *testing.T) {
	...
	ch.ExecuteCommand(fixtures.Repo, models.Repo{} /* this isn't used */, fixtures.User, fixtures.Pull.Num, &cmd, models.Github)
