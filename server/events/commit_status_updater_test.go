...
func TestUpdate(t *testing.T) {
	...
	err := s.Update(repoModel, pullModel, status, &cmd, models.Github)
	Ok(t, err)
	client.VerifyWasCalledOnce().UpdateStatus(repoModel, pullModel, status, "Plan Success", models.Github)
}
...
func TestUpdateProjectResult_Error(t *testing.T) {
	...
	Ok(t, err)
	client.VerifyWasCalledOnce().UpdateStatus(repoModel, pullModel, vcs.Failed, "Plan Failed", models.Github)
}
...
func TestUpdateProjectResult(t *testing.T) {
	...
	for _, c := range cases {
		...
		Ok(t, err)
		client.VerifyWasCalledOnce().UpdateStatus(repoModel, pullModel, c.Expected, "Plan "+strings.Title(c.Expected.String()), models.Github)
	}
}
