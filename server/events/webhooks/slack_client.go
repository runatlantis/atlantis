...
//go:generate mockgen -destination=mocks/mock_slack_client.go -package=mocks . SlackClient
...
//go:generate mockgen -destination=mocks/mock_underlying_slack_client.go -package=mocks . UnderlyingSlackClient
