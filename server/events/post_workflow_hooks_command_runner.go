...
//go:generate mockgen -destination=mocks/mock_post_workflow_hook_url_generator.go -package=mocks . PostWorkflowHookURLGenerator
...
//go:generate mockgen -destination=mocks/mock_post_workflows_hooks_command_runner.go -package=mocks . PostWorkflowHooksCommandRunner
