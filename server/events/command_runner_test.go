...
func TestRunCommentCommand_LogPanics(t *testing.T) {
	...
	vcsClient := setup(t)
	When(githubGetter.GetPullRequest(Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num)).ThenPanic("panic test - if you're seeing this in a test failure this isn't the failing test")
...
func TestRunCommentCommand_GithubPullErr(t *testing.T) {
	...
	vcsClient := setup(t)
	When(githubGetter.GetPullRequest(Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num)).ThenReturn(nil, errors.New("err"))
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "`Error: making pull request API call to GitHub: err`", "")
}
...
func TestRunCommentCommand_GitlabMergeRequestErr(t *testing.T) {
	...
	vcsClient := setup(t)
	When(gitlabGetter.GetMergeRequest(Any[logging.SimpleLogging](), testdata.GitlabRepo.FullName, testdata.Pull.Num)).ThenReturn(nil, errors.New("err"))
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GitlabRepo, testdata.Pull.Num, "`Error: making merge request API call to GitLab: err`", "")
}
...
func TestRunCommentCommand_GithubPullParseErr(t *testing.T) {
	...
	When(eventParsing.ParseGithubPull(Any[logging.SimpleLogging](), &pull)).ThenReturn(testdata.Pull, testdata.GithubRepo, testdata.GitlabRepo, errors.New("err"))

	ch.RunCommentCommand(testdata.GithubRepo, &testdata.GithubRepo, nil, testdata.User, testdata.Pull.Num, &events.CommentCommand{Name: command.Plan})
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "`Error: extracting required fields from comment data: err`", "")
}
...
func TestRunCommentCommand_TeamAllowListChecker(t *testing.T) {
	t.Run("nil checker", func(t *testing.T) {
		...
		vcsClient.VerifyWasCalledOnce().CreateComment(
			Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull.Num, "Ran Plan for 0 projects:", "plan")
	})
...
func TestRunCommentCommand_ForkPRDisabled(t *testing.T) {
	...
	When(eventParsing.ParseGithubPull(Any[logging.SimpleLogging](), &pull)).ThenReturn(modelPull, modelPull.BaseRepo, headRepo, nil)
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull.Num, commentMessage, "")
}
...
func TestRunCommentCommand_DisableApplyAllDisabled(t *testing.T) {
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull.Num,
		"**Error:** Running `atlantis apply` without flags is disabled. You must specify which project to apply via the `-d <dir>`, `-w <workspace>` or `-p <project name>` flags.", "apply")
}
...
func TestRunCommentCommand_DisableAutoplanLabel(t *testing.T) {
	...
	When(ch.VCSClient.GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)).ThenReturn([]string{"disable-auto-plan", "need-help"}, nil)

	ch.RunAutoplanCommand(testdata.GithubRepo, testdata.GithubRepo, modelPull, testdata.User)
	projectCommandBuilder.VerifyWasCalled(Never()).BuildAutoplanCommands(Any[*command.Context]())
	vcsClient.VerifyWasCalledOnce().GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)
}
...
func TestRunCommentCommand_DisableAutoplanLabel_PullNotLabeled(t *testing.T) {
	...
	When(ch.VCSClient.GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)).ThenReturn(nil, nil)
...
func TestRunCommentCommand_ClosedPull(t *testing.T) {
	...
	ch.RunCommentCommand(testdata.GithubRepo, &testdata.GithubRepo, nil, testdata.User, testdata.Pull.Num, &events.CommentCommand{Name: command.Plan})
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull.Num, "Atlantis commands can't be run on closed pull requests", "")
}
...
func TestRunUnlockCommand_VCSComment(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			vcsClient.VerifyWasCalledOnce().CreateComment(
				Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num,
				"All Atlantis locks for this PR have been unlocked and plans discarded", "unlock")
		})
	}
}
...
func TestRunUnlockCommandFail_VCSComment(t *testing.T) {
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "Failed to delete PR locks", "unlock")
}
...
func TestRunUnlockCommandFail_DisableUnlockLabel(t *testing.T) {
	...
	When(eventParsing.ParseGithubPull(Any[logging.SimpleLogging](), pull)).ThenReturn(modelPull, modelPull.BaseRepo, testdata.GithubRepo, nil)
	When(deleteLockCommand.DeleteLocksByPull(testdata.GithubRepo.FullName, testdata.Pull.Num)).ThenReturn(0, errors.New("err"))
	When(ch.VCSClient.GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)).ThenReturn([]string{doNotUnlock, "need-help"}, nil)

	ch.RunCommentCommand(testdata.GithubRepo, &testdata.GithubRepo, nil, testdata.User, testdata.Pull.Num, &events.CommentCommand{Name: command.Unlock})

	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "Not allowed to unlock PR with "+doNotUnlock+" label", "unlock")
}
...
func TestRunUnlockCommandFail_GetLabelsFail(t *testing.T) {
	...
	When(eventParsing.ParseGithubPull(Any[logging.SimpleLogging](), pull)).ThenReturn(modelPull, modelPull.BaseRepo, testdata.GithubRepo, nil)
	When(deleteLockCommand.DeleteLocksByPull(testdata.GithubRepo.FullName, testdata.Pull.Num)).ThenReturn(0, errors.New("err"))
	When(ch.VCSClient.GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)).ThenReturn(nil, errors.New("err"))

	ch.RunCommentCommand(testdata.GithubRepo, &testdata.GithubRepo, nil, testdata.User, testdata.Pull.Num, &events.CommentCommand{Name: command.Unlock})

	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "Failed to retrieve PR labels... Not unlocking", "unlock")
}
...
func TestRunUnlockCommandDoesntRetrieveLabelsIfDisableUnlockLabelNotSet(t *testing.T) {
	...
	vcsClient.VerifyWasCalled(Never()).GetPullLabels(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull)
}
...
func TestApplyMergeablityWhenPolicyCheckFails(t *testing.T) {
	...
	When(ch.VCSClient.PullIsMergeable(Any[logging.SimpleLogging](), testdata.GithubRepo, modelPull, "atlantis-test")).ThenReturn(true, nil)
...
func TestApplyWithAutoMerge_VSCMerge(t *testing.T) {
	...
	vcsClient.VerifyWasCalledOnce().MergePull(Any[logging.SimpleLogging](), modelPull, pullOptions)
}
...
func TestRunApply_DiscardedProjects(t *testing.T) {
	...
	When(githubGetter.GetPullRequest(Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num)).ThenReturn(ghPull, nil)
	When(eventParsing.ParseGithubPull(Any[logging.SimpleLogging](), ghPull)).ThenReturn(pull, pull.BaseRepo, testdata.GithubRepo, nil)
	When(workingDir.GetPullDir(Any[models.Repo](), Any[models.PullRequest]())).
		ThenReturn(tmp, nil)
...
func TestRunCommentCommand_DrainOngoing(t *testing.T) {
	...
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "Atlantis server is shutting down, please try again later.", "")
}
...
func TestRunCommentCommand_DrainNotOngoing(t *testing.T) {
	...
	When(githubGetter.GetPullRequest(Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num)).ThenPanic("panic test - if you're seeing this in a test failure this isn't the failing test")
	ch.RunCommentCommand(testdata.GithubRepo, &testdata.GithubRepo, nil, testdata.User, testdata.Pull.Num, &events.CommentCommand{Name: command.Plan})
	githubGetter.VerifyWasCalledOnce().GetPullRequest(Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num)
...
func TestRunAutoplanCommand_DrainOngoing(t *testing.T) {
	...
	ch.RunAutoplanCommand(testdata.GithubRepo, testdata.GithubRepo, testdata.Pull, testdata.User)
	vcsClient.VerifyWasCalledOnce().CreateComment(
		Any[logging.SimpleLogging](), testdata.GithubRepo, testdata.Pull.Num, "Atlantis server is shutting down, please try again later.", "plan")
}
