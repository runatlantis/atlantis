...
//go:generate mockgen -destination=mocks/mock_command_runner.go -package=mocks github.com/runatlantis/atlantis/server/events CommandRunner
...
//go:generate mockgen -destination=mocks/mock_github_pull_getter.go -package=mocks github.com/runatlantis/atlantis/server/events GithubPullGetter
...
//go:generate mockgen -destination=mocks/mock_azuredevops_pull_getter.go -package=mocks github.com/runatlantis/atlantis/server/events AzureDevopsPullGetter
...
//go:generate mockgen -destination=mocks/mock_gitlab_merge_request_getter.go -package=mocks github.com/runatlantis/atlantis/server/events GitlabMergeRequestGetter
