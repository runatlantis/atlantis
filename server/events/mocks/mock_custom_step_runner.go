...
func (mock *MockCustomStepRunner) Run(_param0 command.ProjectContext, _param1 string, _param2 string, _param3 map[string]string, _param4 bool, _param5 valid.PostProcessRunOutputOption) (string, error) {
	if mock == nil {
...
func (verifier *VerifierMockCustomStepRunner) Run(_param0 command.ProjectContext, _param1 string, _param2 string, _param3 map[string]string, _param4 bool, _param5 valid.PostProcessRunOutputOption) *MockCustomStepRunner_Run_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3, _param4, _param5}
