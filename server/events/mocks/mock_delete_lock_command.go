...
func (mock *MockDeleteLockCommand) DeleteLock(id string) (models.DeleteLockCommandResult, *models.ProjectLock, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockDeleteLockCommand().")
	}
	params := []pegomock.Param{id}
	result := pegomock.GetGenericMockFrom(mock).Invoke("DeleteLock", params, []reflect.Type{reflect.TypeOf((*models.DeleteLockCommandResult)(nil)).Elem(), reflect.TypeOf((**models.ProjectLock)(nil)).Elem(), reflect.TypeOf((*error)(nil)).Elem()})
	var ret0 models.DeleteLockCommandResult
	var ret1 *models.ProjectLock
	var ret2 error
	if len(result) != 0 {
		if result[0] != nil {
			ret0 = result[0].(models.DeleteLockCommandResult)
		}
		if result[1] != nil {
...
func (mock *MockDeleteLockCommand) DeleteLocksByPull(repoFullName string, pullNum int) (models.DeleteLockCommandResult, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockDeleteLockCommand().")
	}
	params := []pegomock.Param{repoFullName, pullNum}
	result := pegomock.GetGenericMockFrom(mock).Invoke("DeleteLocksByPull", params, []reflect.Type{reflect.TypeOf((*models.DeleteLockCommandResult)(nil)).Elem(), reflect.TypeOf((*error)(nil)).Elem()})
	var ret0 models.DeleteLockCommandResult
	var ret1 error
	if len(result) != 0 {
		if result[0] != nil {
