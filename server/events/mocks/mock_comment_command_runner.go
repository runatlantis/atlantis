...
func (mock *MockCommentCommandRunner) Run(_param0 *command.Context, _param1 *events.CommentCommand) {
	if mock == nil {
...
func (mock *MockCommentCommandRunner) VerifyWasCalled(invocationCountMatcher pegomock.Matcher) *VerifierMockCommentCommandRunner {
	return &VerifierMockCommentCommandRunner{
		mock:                   mock,
...
func (mock *MockCommentCommandRunner) VerifyWasCalledInOrder(invocationCountMatcher pegomock.Matcher, inOrderContext *pegomock.InOrderContext) *VerifierMockCommentCommandRunner {
	return &VerifierMockCommentCommandRunner{
		mock:                   mock,
		invocationCountMatcher: invocationCountMatcher,
...
func (mock *MockCommentCommandRunner) VerifyWasCalledEventually(invocationCountMatcher pegomock.Matcher, timeout time.Duration) *VerifierMockCommentCommandRunner {
	return &VerifierMockCommentCommandRunner{
		mock:                   mock,
		invocationCountMatcher: invocationCountMatcher,
		timeout:                timeout,
...
func (verifier *VerifierMockCommentCommandRunner) Run(_param0 *command.Context, _param1 *events.CommentCommand) *MockCommentCommandRunner_Run_OngoingVerification {
	params := []pegomock.Param{_param0, _param1}
...
func (c *MockCommentCommandRunner_Run_OngoingVerification) GetCapturedArguments() (*command.Context, *events.CommentCommand) {
	_param0, _param1 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1], _param1[len(_param1)-1]
}

func (c *MockCommentCommandRunner_Run_OngoingVerification) GetAllCapturedArguments() (_param0 []*command.Context, _param1 []*events.CommentCommand) {
