...
func (mock *MockWorkingDir) DeleteForWorkspace(_param0 models.Repo, _param1 models.PullRequest, _param2 string, _param3 string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockWorkingDir().")
	}
...
func (mock *MockWorkingDir) GetWorkingDir(_param0 models.Repo, _param1 models.PullRequest, _param2 string, _param3 string) (string, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockWorkingDir().")
	}
	params := []pegomock.Param{_param0, _param1, _param2, _param3}
...
func (verifier *VerifierMockWorkingDir) DeleteForWorkspace(_param0 models.Repo, _param1 models.PullRequest, _param2 string, _param3 string) *MockWorkingDir_DeleteForWorkspace_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3}
...
func (verifier *VerifierMockWorkingDir) GetWorkingDir(_param0 models.Repo, _param1 models.PullRequest, _param2 string, _param3 string) *MockWorkingDir_GetWorkingDir_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3}
