...
//
//	mockgen -package mocks -destination server/events/mocks/mock_project_command_runner.go github.com/runatlantis/atlantis/server/events ProjectCommandRunner
//
...
func (m *MockProjectCommandRunner) Apply(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Apply", ctx)
	ret0, _ := ret[0].(command.ProjectCommandOutput)
	return ret0
}
...
func (m *MockProjectCommandRunner) ApprovePolicies(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
...
func (m *MockProjectCommandRunner) Import(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
...
func (m *MockProjectCommandRunner) Plan(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
...
func (m *MockProjectCommandRunner) PolicyCheck(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
...
func (m *MockProjectCommandRunner) StateRm(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
...
func (m *MockProjectCommandRunner) Version(ctx command.ProjectContext) command.ProjectCommandOutput {
	m.ctrl.T.Helper()
