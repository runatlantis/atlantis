...
func (mock *MockCommitStatusUpdater) UpdatePreWorkflowHook(repo models.Repo, pull models.PullRequest, status models.CommitStatus, hookDescription string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
	params := []pegomock.Param{repo, pull, status, hookDescription}
...
func (mock *MockCommitStatusUpdater) UpdatePostWorkflowHook(repo models.Repo, pull models.PullRequest, status models.CommitStatus, hookDescription string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
	params := []pegomock.Param{repo, pull, status, hookDescription}
...
func (verifier *VerifierMockCommitStatusUpdater) UpdatePreWorkflowHook(repo models.Repo, pull models.PullRequest, status models.CommitStatus, hookDescription string) *MockCommitStatusUpdater_UpdatePreWorkflowHook_OngoingVerification {
	params := []pegomock.Param{repo, pull, status, hookDescription}
...
func (c *MockCommitStatusUpdater_UpdatePreWorkflowHook_OngoingVerification) GetCapturedArguments() (models.Repo, models.PullRequest, models.CommitStatus, string) {
	repo, pull, status, hookDescription := c.GetAllCapturedArguments()
	return repo[len(repo)-1], pull[len(pull)-1], status[len(status)-1], hookDescription[len(hookDescription)-1]
}

func (c *MockCommitStatusUpdater_UpdatePreWorkflowHook_OngoingVerification) GetAllCapturedArguments() (_param0 []models.Repo, _param1 []models.PullRequest, _param2 []models.CommitStatus, _param3 []string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]models.Repo, len(c.methodInvocations))
		for u, param := range params[0] {
...
func (verifier *VerifierMockCommitStatusUpdater) UpdatePostWorkflowHook(repo models.Repo, pull models.PullRequest, status models.CommitStatus, hookDescription string) *MockCommitStatusUpdater_UpdatePostWorkflowHook_OngoingVerification {
	params := []pegomock.Param{repo, pull, status, hookDescription}
...
func (c *MockCommitStatusUpdater_UpdatePostWorkflowHook_OngoingVerification) GetCapturedArguments() (models.Repo, models.PullRequest, models.CommitStatus, string) {
	repo, pull, status, hookDescription := c.GetAllCapturedArguments()
	return repo[len(repo)-1], pull[len(pull)-1], status[len(status)-1], hookDescription[len(hookDescription)-1]
}

func (c *MockCommitStatusUpdater_UpdatePostWorkflowHook_OngoingVerification) GetAllCapturedArguments() (_param0 []models.Repo, _param1 []models.PullRequest, _param2 []models.CommitStatus, _param3 []string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]models.Repo, len(c.methodInvocations))
		for u, param := range params[0] {
