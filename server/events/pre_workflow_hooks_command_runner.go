...
//go:generate mockgen -destination=mocks/mock_pre_workflow_hook_url_generator.go -package=mocks . PreWorkflowHookURLGenerator
...
//go:generate mockgen -destination=mocks/mock_pre_workflows_hooks_command_runner.go -package=mocks . PreWorkflowHooksCommandRunner
