...
`
	asyncTf.Output = remotePlanOutput
...
func newAsyncTFExecMock() *tfExecMock {
	return &tfExecMock{OutCh: make(chan string), ErrCh: make(chan error)}
}
