...
func (d *ClientProxy) GetTeamNamesForUser(repo models.Repo, user models.User, configuredTeams []string) ([]string, error) {
	return d.clients[repo.VCSHost.Type].GetTeamNamesForUser(repo, user, configuredTeams)
}
