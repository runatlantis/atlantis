...
type ClientProxy interface {
	...
	MergePull(repo models.Repo, pull models.PullRequest) (bool, error)
}
...
func (d *DefaultClientProxy) MergePull(repo models.Repo, pull models.PullRequest) (bool, error) {
	return d.clients[repo.VCSHost.Type].MergePull(repo, pull)
}
