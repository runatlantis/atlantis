...
func TestGithubClient_PullIsMergeableWithAllowMergeableBypassApply(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"blocked",
			"optional-check-failed.json",
			`"APPROVED"`,
			true,
		},
		{
			"blocked",
			"optional-status-failed.json",
			`"APPROVED"`,
			true,
		},
		{
			"blocked",
			"required-check-failed.json",
			`"APPROVED"`,
			false,
		},
		{
			"blocked",
			"required-check-pending.json",
			`"APPROVED"`,
			false,
		},
		{
			"blocked",
			"required-status-failed.json",
			`"APPROVED"`,
			false,
		},
		{
			"blocked",
			"required-check-skipped.json",
			`"APPROVED"`,
			true,
		},
		{
