...
func TestNewGithubClient_GithubCom(t *testing.T) {
	...
	client, err := NewGithubClient("github.com", &GithubUserCredentials{"user", "pass"}, logging.NewNoopLogger(t), mergeabilityChecker, false)
	Ok(t, err)
...
func TestNewGithubClient_NonGithub(t *testing.T) {
	mergeabilityChecker := NewPullMergeabilityChecker("atlantis")
	client, err := NewGithubClient("example.com", &GithubUserCredentials{"user", "pass"}, logging.NewNoopLogger(t), mergeabilityChecker, false)
	Ok(t, err)
