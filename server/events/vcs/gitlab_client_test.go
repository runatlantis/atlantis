...
func TestGitlabClient_GetTeamNamesForUser(t *testing.T) {
	configuredTeams := []string{"someorg/group1", "someorg/group2", "someorg/group3", "someorg/group4"}
	testServer := httptest.NewServer(
		http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			switch r.RequestURI {
			case "/api/v4/users?username=testuser":
				w.WriteHeader(http.StatusOK)
				w.Write([]byte(userSuccess)) // nolint: errcheck
			case "/api/v4/groups/someorg%2Fgroup1/members/123", "/api/v4/groups/someorg%2Fgroup2/members/123":
				w.WriteHeader(http.StatusOK)
				w.Write([]byte(groupMembershipSuccess)) // nolint: errcheck
...
var groupMembershipSuccess = `{"access_level":50,"created_at":"2023-11-28T01:23:45.789Z","created_by":{"id":456,"username":"someone","name":"Someone","state":"active","locked":false,"avatar_url":"https://gitlab.com/uploads/-/system/user/avatar/456/avatar.png","web_url":"https://gitlab.com/someone"},"expires_at":null,"id":123,"username":"testuser","name":"Test User","state":"active","locked":false,"avatar_url":"https://gitlab.com/uploads/-/system/user/avatar/123/avatar.png","web_url":"https://gitlab.com/testuser","membership_state":"active"}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  //nolint:gosec // No credentials
var userSuccess = `[{"id":123,"username":"testuser","name":"Test User","state":"active","locked":false,"avatar_url":"https://gitlab.com/uploads/-/system/user/avatar/123/avatar.png","web_url":"https://gitlab.com/testuser"}]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      //nolint:gosec // No credentials
