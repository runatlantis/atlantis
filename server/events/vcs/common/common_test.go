...
func TestSplitComment_DynamicSeparators(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			comment:       "This is a long comment that will be split. This is additional content to make the comment longer so it will be split.",
			maxSize:       70,
			maxComments:   0,
			command:       "plan",
			expectedCount: 3,
		...
		},
		{
			...
			comment:       "Here's some code:\n```\nterraform plan\noutput here\n```\nAnd more text. This is additional content to make the comment longer so it will be split.",
			maxSize:       100,
			maxComments:   0,
			command:       "plan",
			expectedCount: 2,
			expectedComments: []string{
				"Here's some code:\n```\nterraform plan\noutput here\n```\nAnd more <!-- END -->",
				"<!-- START plan -->text. This is additional content to make the comment longer so it will be split.",
			},
		},
		{
