...
//go:generate mockgen -destination=mocks/mock_pull_req_status_fetcher.go -package=mocks github.com/runatlantis/atlantis/server/events/vcs PullReqStatusFetcher
