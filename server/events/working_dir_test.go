...
func TestClone_NoneExisting(t *testing.T) {
	...
	cloneDir, err := wd.Clone(models.Repo{}, models.PullRequest{
...
func TestClone_CheckoutMergeNoReclone(t *testing.T) {
	...
	_, err := wd.Clone(models.Repo{}, models.PullRequest{
		BaseRepo:   models.Repo{},
		HeadBranch: "branch",
		BaseBranch: "main",
	}, "default")
...
func TestClone_MasterHasDiverged(t *testing.T) {
	...
	Ok(t, err)
	mergedAgain, err := wd.MergeAgain(models.Repo{CloneURL: repoDir}, models.PullRequest{
