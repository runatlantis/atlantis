...
//	_, err := r.ParseRepoCfg("/not/exist", valid.GlobalCfg{}, "")
...
//
//	r := yaml.ParserValidator{}
//	_, err := r.ParseRepoCfg(tmpDir, valid.GlobalCfg{}, "")
//	Assert(t, os.IsNotExist(err), "exp nil ptr")
//
...
//
//			r := yaml.ParserValidator{}
//			act, err := r.ParseRepoCfg(tmpDir, valid.GlobalCfg{}, "")
//			if c.expErr != "" {
...
//
//			r := yaml.ParserValidator{}
//			repoConfig, err := r.ParseGlobalCfg(filepath.Join(tmpDir, "repo.yaml"))
//			Ok(t, err)
//			act, err := r.ParseRepoCfg(tmpDir, repoConfig, c.repoName)
//			if c.expErr != "" {
//				ErrEquals(t, "parsing atlantis.yaml: "+c.expErr, err)
//				return
//			}
...
//	r := yaml.ParserValidator{}
//	_, err := r.ParseGlobalCfg("/not/exist")
...
//
//	r := yaml.ParserValidator{}
//	_, err = r.ParseGlobalCfg(repoYamlFile)
