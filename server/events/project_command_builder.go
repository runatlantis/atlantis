...
//go:generate mockgen -destination=mocks/mock_project_command_builder.go -package=mocks github.com/runatlantis/atlantis/server/events ProjectCommandBuilder
