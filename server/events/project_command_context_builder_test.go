...
func TestProjectCommandContextBuilder_PullStatus(t *testing.T) {
	...
	t.Run("with project name defined", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, valid.Autodiscover{Enabled: true}, false, false, false, false, terraformClient)
	...
	t.Run("when ParallelApply is set to true", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, valid.Autodiscover{Enabled: true}, true, false, false, false, terraformClient)
	...
	t.Run("when AbortOnExcecutionOrderFail is set to true", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, valid.Autodiscover{Enabled: true}, false, false, false, true, terraformClient)
