...
func TestProjectCommandContextBuilder_PullStatus(t *testing.T) {
	...
	t.Run("with project name defined", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, false, false, false, false, terraformClient, "merge")
	...
	t.Run("when ParallelApply is set to true", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, true, false, false, false, terraformClient, "merge")
	...
	t.Run("when AbortOnExecutionOrderFail is set to true", func(t *testing.T) {
		...
		result := subject.BuildProjectContext(commandCtx, command.Plan, "", projCfg, []string{}, "some/dir", false, false, false, false, true, terraformClient, "merge")
