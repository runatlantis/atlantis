...
const (
	...
	SilenceVCSStatusPreWorkflowHookFlag = "silence-vcs-status-pre-workflow-hook"
...
var boolFlags = map[string]boolFlag{
	...
	SilenceVCSStatusPreWorkflowHookFlag: {
		description:  "Silences VCS commit status updates for pre-workflow hooks.",
		defaultValue: false,
	},
