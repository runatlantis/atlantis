...
Para probar Atlantis en un repositorio de ejemplo, descarga la última versión desde
...
- Si estás listo para probar Atlantis en ejecución en **tus repositorios**, entonces lee [Testing Locally](testing-locally.md).
