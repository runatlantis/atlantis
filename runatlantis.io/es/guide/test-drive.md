...
Para probar Atlantis en un repositorio de ejemplo, descarga la versión más reciente desde
...
- Si estás listo para instalar correctamente Atlantis en infraestructura real, entonces ve a la [Installation Guide](../docs/installation-guide.md).
