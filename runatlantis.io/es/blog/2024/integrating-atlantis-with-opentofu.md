...
**3** - Edita el archivo values.yaml y agrega tus credenciales de acceso y secret que se usarán en la configuración del webhook de Atlantis:
...
**5** - Ahora configuremos el script que se ejecutará al inicio del pod init de Atlantis. En este paso descargamos e instalamos Terragrunt y OpenTofu, así como incluimos sus binarios en el dir compartido
...
**8** - Configura el ingress del webhook de Atlantis, en el ejemplo a continuación estamos usando AWS ALB.
...
**10** - Ahora vayamos a la instalación en sí, busca las versiones disponibles de Atlantis:
...
Ahora, mira cómo configurar el [webhook en github](../../docs/configuring-webhooks.md) del repositorio de Atlantis.

Mira cómo [funciona Atlantis](../../docs/using-atlantis.md).
