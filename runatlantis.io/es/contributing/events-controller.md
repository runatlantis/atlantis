...
Merge Request, o como sea llamado para el VCS respectivo. Después de analizar la
...
comandos listados abajo y, por último, los hooks post-workflow.
...
La siguiente lista enlaza a los VCS soportados y a su documentación de
Webhook de Pull Request.
...
Cada vez que un Pull Request se cierra, la función `CleanUpPull` en el archivo
