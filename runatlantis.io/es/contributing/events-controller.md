...
Para manejar eventos de comentarios en Pull Requests, primero deben crearse. Atlantis
también permite la ejecución de comandos para ciertos eventos de Pull Requests.

<details>
  <summary>Webhooks de Pull Request</summary>

La siguiente lista enlaza a los VCS soportados y su documentación de Webhook
de Pull Request.
...
archivo [command_runner.go](https://github.com/runatlantis/atlantis/blob/main/server/events/command_runner.go)
se llama para los eventos de Pull Request _Open_ y _Update_. Cuando está habilitado en
el proyecto, esto ejecuta automáticamente el `plan` para el repositorio específico.

Cada vez que un Pull Request se cierra, la función `CleanUpPull` en el
...
se llama. Esta función limpia todos los archivos del Pull Request cerrado,
