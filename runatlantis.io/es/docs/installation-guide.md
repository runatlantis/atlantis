...
Esta guía es para instalar una instancia de Atlantis **lista para producción** en tu
infraestructura:

1. Primero, asegúrate de que tu configuración de Terraform cumpla con los **requisitos** de Atlantis
...
1. Configura **credenciales del provider** para que Atlantis realmente pueda ejecutar comandos de Terraform
    * Consulta [Provider Credentials](provider-credentials.md)

:::tip
Si quieres probar Atlantis primero, revisa [Test Drive](../guide/test-drive.md)
