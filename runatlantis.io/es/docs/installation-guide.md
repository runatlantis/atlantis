...
1. Crea un **secreto de webhook** para que Atlantis pueda validar webhooks
...
1. Configura **credenciales de proveedor** para que Atlantis realmente pueda ejecutar comandos de Terraform
