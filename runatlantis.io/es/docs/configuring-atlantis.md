...
Consulte [Server Configuration](server-configuration.md) para más detalles.
...
Los archivos `atlantis.yaml` colocados en la raíz de sus repositorios de Terraform pueden usarse para
cambiar el comportamiento predeterminado de Atlantis para cada repositorio.

Consulte [Repo-Level atlantis.yaml Files](repo-level-atlantis-yaml.md) para más detalles.
