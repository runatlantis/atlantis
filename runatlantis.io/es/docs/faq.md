...
**P: ¿Cómo ejecutar Atlantis en modo de alta disponibilidad? ¿Lo necesita?**

R: El servidor Atlantis puede ejecutarse fácilmente bajo la supervisión de un sistema init como `upstart` o `systemd` para asegurarse de que `atlantis server` siempre esté en ejecución.
