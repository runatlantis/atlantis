...
Esta opción puede configurarse ya sea a nivel del servidor en un [archivo de configuración repos.yaml](server-configuration.md) o a nivel del repositorio en un [archivo atlantis.yaml](repo-level-atlantis-yaml.md).

::: tip
Las verificaciones de políticas personalizadas admiten [aprobaciones de políticas persistentes](policy-checking.md#sticky-policy-approvals). Use `policy_item_regex` para apuntar a las líneas de fallo significativas en la salida de su herramienta.
:::
