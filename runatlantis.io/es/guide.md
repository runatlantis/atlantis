...
* Si solo te gustaría probar ejecutar Atlantis en un **repo de ejemplo**, consulta [Test Drive](./guide/test-drive.md).
...
Cuando quieras hacer apply, comenta `atlantis apply` en el pull request y Atlantis
...
Puedes requerir aprobación antes de que el pull request se aplique para que no suceda nada
accidentalmente.
...
Los comandos exactos que Atlantis ejecuta son configurables. Puedes ejecutar scripts personalizados
