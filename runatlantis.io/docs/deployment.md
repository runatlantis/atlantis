...
**Note:** If you are using Atlantis with multiple GitLab repositories, you must either use the same Integration secret token cross all repositories, or use a separate Atlantis instance for each repository.  The former approach is recommended.
