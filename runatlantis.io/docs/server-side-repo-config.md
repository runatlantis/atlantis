...
| policy_item_regex        | string          | `.*`    | no       | regex to extract comparable items from policy output for sticky approval tracking. See [Sticky Policy Approvals](policy-checking.md#sticky-policy-approvals). |
