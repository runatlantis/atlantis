...
### `--gh-token-file`
  ...
  GitHub token of API user. The token is loaded loaded from disk regularly to allow for rotation of the token without the need to restart the Atlantis server.
